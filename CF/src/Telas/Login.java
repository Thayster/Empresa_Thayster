...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("copyright © thayster name All rights reserved");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Telas/techh.jpg"))); // NOI18N
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
        if(user.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Por Favor, Preencha os Campos!");
        } else if(user.getText().contains("thayster") && senha.getText().contains("tech25")){
